...
void mostrarEnvios()
{
    for (int i = 0; i < tam; i++)
    {
        printf("Identificacion del PEDIDO: %d \t", numerosID[i]);
        printf(" El peso del PEDIDO es: %.2f \t", pesos[i]);
        switch (destinos[i])
        {
        case 1:
            printf("Destino: Rosario");
            break;
        case 2:
            printf("Destino: Funes");
            break;
        case 3:
            printf("Destino: Roldan");
            break;
        case 4:
            printf("Destino: Baigorria");
            break;
        default:
...
void mostrarEnvioParaDestino(int destino)
{
    ...
    switch (destinos[i])
    {
        ...
        case 3:
            printf("Destino: Roldan \n");
            printf("Los ENVIOS a Roldan son los: ID%i, %i  ", numerosID[i]);
            break;
        case 4:
            printf("Destino: Baigorria");
            break;
